...
![image](https://github.com/user-attachments/assets/751308ea-998a-45fb-9470-a42758128dd9)

Попробуем ускорить выполнение этого запроса

![image](https://github.com/user-attachments/assets/d808c042-7e06-4ac9-8cfc-73f16fe236e3)

![image](https://github.com/user-attachments/assets/bf892f50-5953-4bdf-a3e0-83c79cfe6666)
...
Вложенный подзапрос, агрегирующий таблицу «Посадочные талоны» (boarding_passes), выполняется дважды. Если бы мы смогли сохранить результат первого выполнения этого подзапроса
во временную таблицу, нам не пришлось бы выполнять то же самое действие повторно.

![image](https://github.com/user-attachments/assets/959a3661-cd14-4423-94d8-e966bcd4d233)

![image](https://github.com/user-attachments/assets/0c7bee7a-3bd6-49ea-9c49-c214c25c598e)
...
![image](https://github.com/user-attachments/assets/1624a285-8fa1-448b-b652-9151bd62c221)

В конструкции WITH можно написать несколько подзапросов, при этом один
подзапрос может ссылаться на другие, то есть обращаться к результатам их выполнения. Конечно, циклические ссылки не допускаются.
Давайте перенесем оба подзапроса из главного запроса в конструкцию WITH.
Теперь все подготовительные действия по группировке данных выполняются
в конструкции WITH, а в главном запросе полученные результаты используются
так, как будто они хранятся в таблицах.

![image](https://github.com/user-attachments/assets/8156730f-801f-4576-84ba-d54ba9584fb6)


Эта модификация не ускоряет запрос, но делает его текст более понятным.

![image](https://github.com/user-attachments/assets/0839a411-100a-4f60-8e90-087ee0d31d83)

![image](https://github.com/user-attachments/assets/4a0a71d6-0842-4693-9ce2-f9a9dc3d2bb0)
